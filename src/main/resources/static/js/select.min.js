    ...
    b.prototype = {
        generate: function() {
            if (!this.$select) {
                ...
                a(document).click(function() {
                    b.multiple || b.$optionsHolder.hide(),
                    b.onBlur()
                }),
        ...
        reset: function() {
            ...
            this.$el.children().each(function() {
                ...
                d || (d = new c(this, b), a.data(this, "wSelect-option", d)),
        ...
        onBlur: function(a) {
            a = a || "active",
            this.options.highlight && this.$select.removeClass("wSelect-" + a)
        },
        setTheme: function(a) {
    ...
    c.prototype = {
        generate: function() {
            ...
            if (!this.$option) {
                ...
                "string" == typeof c && (this.$value.addClass("wSelect-option-icon"), this.$value.css("backgroundImage", "url(" + c + ")").css('background-size','20px 20px'))
            }
        ...
        select: function() {
            if (this.wSelect.activeOpt || (this.wSelect.activeOpt = this), !this.wSelect.multiple) {
                ...
                "string" == typeof a ? (this.wSelect.$selected.addClass("wSelect-option-icon"), this.wSelect.$selected.css("backgroundImage", "url(" + a + ")").css('background-size','20px 20px')) : (this.wSelect.$selected.removeClass("wSelect-option-icon"), this.wSelect.$selected.css("backgroundImage", "")),
        ...
        setWidth: function() {
            ...
            a > this.wSelect.$select.width() && this.wSelect.$select.width(a),
