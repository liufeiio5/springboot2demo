...
import com.qgwy.alpha_web_manager.exception.AlphaExceptionResolver;
...
public class ExceptionConfig {
    // 注册统一异常处理bean
    @Bean
    public AlphaExceptionResolver alphaExceptionResolver() {
        return new AlphaExceptionResolver();
    }
