...
public class ProductItemController {
    ...
    public Map<String,Object> getProductDetails(Integer page,Integer size,Integer marketId,Integer categoryId){
    ...
    public Map<String,Object> getProductItemList(Integer page,Integer size,Integer marketId){
        Map<String,Object> map = new HashMap<>();
