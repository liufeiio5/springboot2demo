package com.zftx.mcdaily.aop.aspect;
...
public class DataSourceAspect implements Ordered {
	...
	@Pointcut("@annotation(com.zftx.mcdaily.annotation.DataSource)")//注意：这里的xxxx代表的是上面public @interface DataSource这个注解DataSource的包名
